...
var form_widget_amount_slider_handle = '/inc/advanced/img/slider_handle.gif';
var slider_handle_image_obj = false;

if(sliderObjectArray==undefined)
	var sliderObjectArray = new Array();
if(slider_counter==undefined)
...
function form_widget_amount_slider(targetEl,formTarget,width,min,max,onchangeAction)
{
	if(!slider_handle_image_obj){
	...
	targetEl.appendChild(parentObj);
