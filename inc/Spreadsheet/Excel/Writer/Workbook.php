...
require_once($_SERVER['DOCUMENT_ROOT']."/inc/Spreadsheet/Excel/Writer/Format.php");
require_once($_SERVER['DOCUMENT_ROOT']."/inc/Spreadsheet/Excel/Writer/BIFFwriter.php");
require_once($_SERVER['DOCUMENT_ROOT']."/inc/Spreadsheet/Excel/Writer/Worksheet.php");
require_once($_SERVER['DOCUMENT_ROOT']."/inc/Spreadsheet/Excel/Writer/Parser.php");
require_once($_SERVER['DOCUMENT_ROOT']."/inc/OLE/PPS/Root.php");
require_once($_SERVER['DOCUMENT_ROOT']."/inc/OLE/PPS/File.php");
